// https://observablehq.com/@wfinneran/bar-chart-race-explained@3018
export default function define(runtime, observer) {
  const main = runtime.module();
  const fileAttachments = new Map([["Music_Data@1.csv",new URL("./files/77880e5f757d52b692dc3c8b1548599b7d9633d103af8b2f4f79ccbe7d8c2e26187f5ac98c06f17edc22f94f6e605c3334921bec2789e277653cd8acd2e7fd1b",import.meta.url)]]);
...
d3.csvParse(await FileAttachment("Music_Data@1.csv").text(), d3.autoType)
)});
  main.variable(observer()).define(["md"], function(md){return(
...
md`## 60 Years of Number 1 Songs

Number of Weeks #1, Source: Genius.com Billboard.com`
)});
